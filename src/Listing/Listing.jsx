...
const Listing = () => {
  ...
  console.log("which is slug.. and name", slug, name);
  ...
  const getNewsListData = async (name, slug) => {
    ...
    try {
      ...
      if (slug === "web-stories") {
        response = await NewsList.getWebStoriesList(name, slug);
      } else {
        response = await NewsList.getNewsListingCatSubCatList(
          name,
          slug,
          newsLimit
        );
  ...
  useEffect(() => {
    if (name && slug) {
      getNewsListData(name, slug, newsLimit);
    }
    setNewsLimit(3);
  }, [newsLimit, name, slug]);
  ...
  const getCategoryPopularRecenNewstList = async (name, slug) => {
    ...
    try {
      ...
      response = await NewsList.getCategoryPopularRecentList(name, slug);
      const data = response?.data?.data;
      const totalCount = response?.data?.totalCount;

      console.log("response for the webstores", data);
          ...
          categoryBasedNewsList[0]?.blogCategory && (
            <Helmet>
              ...
              <meta
                ...
                content={
                  ...
                  "Default description about real estate news and updates."
                }
              />
              ...
              <meta
                name="keywords"
                content={
                  categoryBasedNewsList[0].blogCategory.categoryKeywords ||
            ...
            /> */}
              ...
              <meta
                ...
                content={
                  categoryBasedNewsList[0].blogCategory
                    .categoryMetaDescription || "Default OG Description"
                }
              />
              {/* <meta
              property="og:image"
              content={
                categoryBasedNewsList[0].blogCategory.categoryOgImage ||
            ...
            /> */}
              ...
              <meta
                ...
                content={
                  categoryBasedNewsList[0].blogCategory
                    .categoryMetaDescription || "Default Twitter Description"
                }
              />
              {/* <meta
              name="twitter:image"
            ...
            /> */}
              ...
              {categoryBasedNewsList[0].blogCategory.schema && (
                <script type="application/ld+json">
                  {JSON.stringify(categoryBasedNewsList[0].blogCategory.schema)}
                </script>
              )}
            </Helmet>
          )
        : categoryBasedNewsList.length > 0 &&
          categoryBasedNewsList[0]?.blogSubCategory && (
            <Helmet>
              {/* Page Title */}
              <title>
                {categoryBasedNewsList[0].blogSubCategory.metaTitle ||
                  "Default Title"}
              </title>
              ...
              <meta
                name="description"
                content={
                  categoryBasedNewsList[0].blogSubCategory.metaDescription ||
                  "Default description about real estate news and updates."
                }
              />
              ...
              <meta
                name="keywords"
                content={
                  categoryBasedNewsList[0].blogSubCategory.metaKeywords ||
                  "real estate, property, housing"
                }
              />
                    ...
                    >
                      <nav id="breadcrumb">
                        ...
                        >
                          /{" "}
                          {slug === "web-stories"
                            ? categoryBasedNewsList[0]?.blogCategory?.name
                            : categoryBasedNewsList[0]?.blogCategory?.name}
                        </Link>
                        ...
                        {name === "subcategory" && (
                          ...
                          >
                            /{" "}
                            {slug === "web-stories"
                              ? categoryBasedNewsList[0]?.blogSubCategory?.name
                              : categoryBasedNewsList[0]?.blogSubCategory?.name}
                          </Link>
                        )}
                      </nav>
                      ...
                      <div
                        className="taxonomy-description entry"
                    ...
                    {slug !== "web-stories" ? (
                      <div className="mag-box small-wide-post-box wide-post-box top-news-box">
                        <div className="container-wrapper">
                          ...
                          >
                            {categoryBasedNewsList?.map((categoryBasedNews) => {
                              return (
                                <ul
                                  id="posts-container"
                                  data-layout="default"
                                  ...
                                  >
                                    ...
                                    >
                                      {/* <span
                                        ...
                                        aria-hidden="true"
                                      /> */}
                                      {categoryBasedNews.blogSubCategory
                                        ?.name === "Youtube" ? (
                                        <iframe
                                          width="100%"
                                          height="140"
                            ...
                            >
                              <a
                                ...
                                onClick={(e) => {
                                  e.preventDefault();
                                  setNewsLimit((prev) => prev + 3);
                                }}
                                data-text={
                                  newsLoading ? "Loading..." : "View More"
                                }
                                style={{
                                  fontSize: "15px",
                                  padding: "8px 16px",
                      ...
                      <div className="container">
                        ...
                        >
                          {categoryBasedNewsList.map((item, index) => (
