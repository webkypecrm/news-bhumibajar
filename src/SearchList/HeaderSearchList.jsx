...
const HeaderSearchList = () => {
  ...
  const getNewsListData = async (name, slug) => {
    ...
    try {
      const response = await NewsList.getNewsCatSubCatList(name, slug);
                        ...
                        <div className="widget-posts-list-wrapper">
                          <div className="widget-posts-list-container timeline-widget">
                            <ul className="posts-list-items widget-posts-wrapper">
                              ...
                              <li className="widget-single-post-item">
                                {" "}
                                <Link to="../../../2016/10/02/new-heroes-of-the-storm-characters-bring-portals/index.html">
                                  <span className="date meta-item tie-icon">
                                    Oct 2, 2016
                                  </span>
                                  <h3>
                                    New Heroes of the Storm Characters Bring
                                    Portals
                                  </h3>
                                </Link>{" "}
                              </li>
                              <li className="widget-single-post-item">
                                {" "}
                                <Link to="../../../2016/09/04/quinoa-new-recipes-feta-broad-bean-salad/index.html">
                                  <span className="date meta-item tie-icon">
                                    Sep 4, 2016
                                  </span>
                                  <h3>
                                    Quinoa new recipes, feta &amp; broad bean
                                    salad
                                  </h3>
                                </Link>{" "}
                              </li>
                              <li className="widget-single-post-item">
                                {" "}
                                <Link to="../../../2016/10/03/6-ways-drinking-warm-water-can-heal-your-body/index.html">
                                  <span className="date meta-item tie-icon">
                                    Oct 3, 2016
                                  </span>
                                  <h3>
                                    6 Ways Drinking Warm Water Can Heal Your
                                    Body
                                  </h3>
                                </Link>{" "}
                              </li>
                              <li className="widget-single-post-item">
                                {" "}
                                <Link to="../../../2016/10/03/five-places-to-shop-in-florence/index.html">
                                  <span className="date meta-item tie-icon">
                                    Oct 3, 2016
                                  </span>
                                  <h3>Five Places to Shop in Florence</h3>
                                </Link>{" "}
                              </li>
                            </ul>
                          </div>
                        ...
                        <ul className="solid-social-icons two-cols transparent-icons Arqam-Lite">
                          <li className="social-icons-item">
                            ...
                            <Link
                              ...
                              to="http://www.facebook.com/WordPress"
                          ...
                          <li className="social-icons-item">
                            ...
                            <Link
                              ...
                              to="http://youtube.com/user/TEAMMESAI"
                              rel="nofollow noopener"
                              target="_blank"
                            >
                              {" "}
                              ...
                              <span className="followers">
                                {" "}
                                <span className="followers-num">53,000</span>
                                <span className="followers-name">
                                  Followers
                                </span>{" "}
                              </span>{" "}
                          ...
                          <li className="social-icons-item">
                            ...
                            <Link
                              ...
                              to="http://vimeo.com/channels/kidproof"
                              rel="nofollow noopener"
                              target="_blank"
                            >
                              {" "}
                          ...
                          <li className="social-icons-item">
                            ...
                            <Link
                              ...
                              to="http://www.behance.net/matiascorea"
                              rel="nofollow noopener"
                              target="_blank"
                            >
                              {" "}
                              ...
                              <span className="followers">
                                {" "}
                                <span className="followers-num">63,179</span>
                                <span className="followers-name">
                                  Followers
                                </span>{" "}
                              </span>{" "}
                          ...
                          <li className="social-icons-item">
                            ...
                            <Link
                              ...
                              to="http://instagram.com/tiedemos"
                              rel="nofollow noopener"
                              target="_blank"
                            >
                              {" "}
